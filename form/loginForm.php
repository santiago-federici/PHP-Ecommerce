...
<body>
  <main class="wrapper">
    ...
    <form  action="./loginFormHandler.php" method='post' class='form login-form'>
      <h1>Log in</h1>
      ...
      <p class='not-registered'>Don't have an account yet? Click <a href='./registerForm.php' class='here-link'>here</a> to register.</p>
    </form>
  </main>
</body>
